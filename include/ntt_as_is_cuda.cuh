...
__global__ void ntt_kernel_cuda_asis(int *g_idata, uint64_t n, uint64_t p, uint64_t r, bool rev, int *g_odata);

extern "C" {

uint64_t *inPlaceNTT_DIT_cuda_asis(uint64_t *vec, uint64_t n, uint64_t p, uint64_t r,
                              bool rev = true);
};
